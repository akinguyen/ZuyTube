<script src='<?=strpos($_SERVER['REQUEST_URI'], 'index.php') > 0 ? "assets/js/loginFunction.js" : "../js/loginFunction.js"?>'></script>

<div id="loginForm" class="modal">
  <form method="POST" class="modal-content animate" action=<?=strpos($_SERVER['REQUEST_URI'], 'index.php') > 0 ? "" : "../../index.php"?>>
